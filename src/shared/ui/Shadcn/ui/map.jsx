...
import { PlaceAutocomplete } from "@/shared/ui/Shadcn/ui/place-autocomplete";
...
function Map({
    ...
    return (
        <LeafletMapContainer
            ...
            zoomControl={false}
            className={cn("z-50 size-full min-h-96 flex-1 rounded-md", classNames)}
            {...props} />
    );
}
...
function MapMarker({
    icon = <img src="/img/map/Marker.svg" alt="marker" />,
    iconAnchor = [12, 12],
    bgPos,
    popupAnchor,
    tooltipAnchor,
